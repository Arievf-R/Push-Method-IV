    ...
    <div className="p-6 bg-white shadow-lg rounded-lg border border-gray-200">
      <div className="mb-4 flex items-center gap-4">
        ...
        <div className="w-full max-w-sm gap-4 flex items-center">
          ...
          />
          <button
            className="py-2 px-4 border bg-white text-nowrap rounded-lg cursor-pointer hover:bg-blue-500 hover:text-white transition"
            onClick={resetFilter}
          >
            Reset Filter
          </button>
              ...
              <tr>
                <td colSpan="5" className="py-2 px-4">
                  <div className="flex justify-end space-x-2">
                    {/* Previous Button */}
                    <button
                      className={`p-1 rounded-md flex items-center justify-center hover:bg-blue-500 hover:text-white transition-all ${
                        page === 1
                    ...
                    {/* Next Button */}
                    <button
                      className="cursor-pointer p-1 bg-white rounded-md flex items-center justify-center hover:bg-blue-500 hover:text-white transition-all"
                      onClick={nextPage}
                    >
